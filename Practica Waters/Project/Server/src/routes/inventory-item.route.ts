...
async function getInventoryItems(
  ...
  try {
    [inventoryItems, count] = await Promise.all([
      inventoryItemService.getAllInventoryItems(req.em, page, limit, req.query.sort ? req.query.sort.toString() : '', req.query.activeOnly === 'true', req.query.filter ? req.query.filter.toString() : ''),
