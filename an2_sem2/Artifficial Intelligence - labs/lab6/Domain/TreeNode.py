...
class TreeNode(object):
    def __init__(self,rowsFromTable,parent):
        ...
        self.neighbours = {1: None,2: None,3: None,4:None,5:None}
        self.attribute=0
    ...
    def __str__(self):
        ...
        stringRepr+="no of L's:"+str(self.instancesOfL)+"  cati de R:"+str(self.instancesOfR)+"  no of B's:"+str(self.instancesOfB)+"\n"
